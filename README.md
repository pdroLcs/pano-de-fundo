...
```powershell
git clone https://github.com/pdroLcs/pano-de-fundo
cd pano-de-fundo
```
...
Exemplo rápido para acesso via XAMPP se o projeto já está em `C:/xampp/htdocs/pano-de-fundo`:

```
http://localhost/pano-de-fundo/public
```
